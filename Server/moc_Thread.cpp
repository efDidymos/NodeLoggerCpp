...
QT_MOC_LITERAL(7, 51, 23), // "QTcpSocket::SocketError"
QT_MOC_LITERAL(8, 75, 11), // "socketError"
QT_MOC_LITERAL(9, 87, 4) // "read"

    },
    "Thread\0send2MainThread\0\0logger\0fileName\0"
    "text\0error\0QTcpSocket::SocketError\0"
    "socketError\0read"
};
...
void Thread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Thread::*_t)(const QString & , const QString & , const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Thread::send2MainThread)) {
                *result = 0;
            }
        }
        {
...
// SIGNAL 0
void Thread::send2MainThread(const QString & _t1, const QString & _t2, const QString & _t3)
{
